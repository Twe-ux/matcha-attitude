...
import { DollarSign, Package, ShoppingCart, Users, TrendingUp, Eye, Crown, Sparkles } from "lucide-react";
      ...
      <div className="relative container mx-auto px-4 py-12">
        <div className="max-w-7xl mx-auto">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    <div className={`w-14 h-14 bg-gradient-to-r ${stat.color} rounded-2xl flex items-center justify-center shadow-premium group-hover:scale-110 transition-transform duration-300`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-premium border border-white/50 p-8 animate-fade-in-up" style={{animationDelay: "0.4s"}}>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-premium border border-white/50 p-8 animate-fade-in-up" style={{animationDelay: "0.5s"}}>
              <div className="text-center">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-premium border border-white/50 p-8 animate-fade-in-up" style={{animationDelay: "0.6s"}}>
              <div className="text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Dernières activités */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-premium border border-white/50 p-8 animate-fade-in-up" style={{animationDelay: "0.7s"}}>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-matcha-50/50 rounded-2xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-matcha-700 font-medium">Nouvelle commande</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-matcha-50/50 rounded-2xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-matcha-700 font-medium">Nouvel utilisateur</span>
                  </div>
                  <span className="text-sm text-neutral-500">Il y a 15 min</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-matcha-50/50 rounded-2xl">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-matcha-700 font-medium">Produit mis à jour</span>
                  </div>
                  <span className="text-sm text-neutral-500">Il y a 1 heure</span>
                </div>
              </div>
            </div>

            {/* Performance Premium */}
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-premium border border-white/50 p-8 animate-fade-in-up" style={{animationDelay: "0.8s"}}>
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-10 h-10 bg-gradient-primary rounded-xl flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-600">Satisfaction client</span>
